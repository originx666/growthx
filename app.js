...
}</pre></details></section><section data-settings-panel="updates" hidden><h3>软件更新</h3><p id="settingsCurrentVersion">当前版本：1.1.1</p><button type="button" id="settingsCheckUpdates">检查更新</button><button type="button" id="settingsDownloadUpdate" hidden>下载更新</button><p id="settingsUpdateStatus" role="status"></p><h4>本版更新内容</h4><p>接通 GitHub 版本检查；发现新版本时可前往对应发布页面下载更新。</p><div id="settingsLatestNotes" style="white-space:pre-wrap"></div></section></div></div>
